...
export const PlannerHeader: React.FC<Props> = ({ onOpenSOS, activeChildName }) => {
  ...
  return (
    <>
      <header className="relative z-40 w-full bg-surface/90 backdrop-blur-md border-b border-border-linen px-4 sm:px-8 py-3.5 transition-all duration-300">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="font-serif text-xl sm:text-2xl lg:text-3xl text-ink font-semibold tracking-tight whitespace-nowrap">
                  Refúgio Familiar
                </h1>
                <span className="hidden sm:inline-flex items-center gap-1 text-[11px] font-sans font-medium px-2.5 py-0.5 rounded-full bg-warm-peach-light text-warm-terracotta border border-border-peach whitespace-nowrap">
                  <Sparkles className="w-3 h-3" />
                  Planner Diário
                </span>
              </div>
              <p className="text-xs sm:text-sm text-ink-muted font-sans flex items-center gap-2 mt-0.5 whitespace-nowrap">
                <Calendar className="w-3.5 h-3.5 text-calm-sage shrink-0" />
